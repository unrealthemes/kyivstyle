...
$common_product_name = get_post_meta( $product->get_id(), '_common_product_name', true );
?>
...
<li id="<?php echo $product->get_id(); ?>" class="product_item" data-attr="product_1">  
    ...
    <a class="product__info" href="<?php echo $product->get_permalink(); ?>">
        ...
        <p class="product__low">
            ...
            <?php if ( $common_product_name ) : ?>

                <span class="product__color"><?php echo $common_product_name; ?> — </span>
